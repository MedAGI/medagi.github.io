  ...
  <div v-else>
    ...
    <div v-else>
      ...
      <div id="dates-table">
        ...
        <div class="date-row">
          <div class="dates"><span class="canceled-date">June 23, 2024</span><br>June 29, 2024 <br> (End of the day, <br>Anywhere on Earth (AoE))</div>
          <div class="due-work">Paper submission due</div>
        </div>
        <div class="date-row">
